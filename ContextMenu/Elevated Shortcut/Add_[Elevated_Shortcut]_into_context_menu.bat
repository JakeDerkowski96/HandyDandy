...
Set "[Path]=%ProgramData%\TenForums.com\%[Name]%.cmd"
If not exist "%ProgramData%\TenForums.com\" (MD "%ProgramData%\TenForums.com\")
...
(
echo :: This script was created by Matthew Wai at TenForums.com/members/matthew-wai.html
echo :: https://www.tenforums.com/tutorials/157437-how-add-create-elevated-shortcut-new-context-menu-windows-10-a.html 
echo :: ************************************************************************************/
